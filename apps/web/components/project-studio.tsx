...
export function ProjectStudio() {
  ...
  const [voiceProvider, setVoiceProvider] = useState('edge_tts');
  const [voiceGender, setVoiceGender] = useState('female');
  const [language, setLanguage] = useState('en');
  const [backgroundMusic, setBackgroundMusic] = useState('calm');
  const [scriptTemplate, setScriptTemplate] = useState('problem_solution');
  const [videoStyle, setVideoStyle] = useState('product_lifestyle');
